...
export function renderParents(): HTMLElement {
  ...
  return h("div", { class: "screen" },
    ...
    h("div", { class: "card" },
      ...
      h("p", { class: "muted small", style: "margin-top:6px" }, "There is no real money in Squishbox. Coins are free and given once a day. Every box shows its odds before opening. Trades swap both sides at once and can't be changed after confirming. Nothing leaves this device."),
    ),
    h("h2", null, "Activity"),
    h("div", { class: "stats" }, stat(s.stats.boxesOpened, "boxes opened"), stat(s.stats.coinsSpent, "coins spent"), stat(s.stats.coinsEarned, "coins earned"), stat(`${s.stats.tradesCompleted} / ${s.stats.tradesCompleted + s.stats.tradesDeclined}`, "trades done / tried")),
    h("h2", null, "Limits"),
    h("div", { class: "card" },
